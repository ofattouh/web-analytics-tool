...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		 ...
		 * @var string
		 */
		protected $menu = 'visualizer-tgmpa-install-plugins';
	...
	if ( ! function_exists( 'load_tgm_plugin_activation' ) ) {
		...
		function load_tgm_plugin_activation() {
			$GLOBALS['tgmpa-visualizer'] = TGM_Plugin_Activation::get_instance();
		}
	}
...
if ( ! function_exists( 'tgmpa' ) ) {
	...
	function tgmpa( $plugins, $config = array() ) {
		...
		if ( ! isset( $GLOBALS['tgmpa-visualizer'] ) ) {
			return;
		}

		$instance = call_user_func( array( get_class( $GLOBALS['tgmpa-visualizer'] ), 'get_instance' ) );
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		public function __construct() {
			...
			$this->tgmpa = call_user_func( array( get_class( $GLOBALS['tgmpa-visualizer'] ), 'get_instance' ) );
...
if ( ! function_exists( 'tgmpa_load_bulk_installer' ) ) {
	...
	function tgmpa_load_bulk_installer() {
		...
		$tgmpa_instance = call_user_func( array( get_class( $GLOBALS['tgmpa-visualizer'] ), 'get_instance' ) );
